                                    ...
                                    <div class="modal-body">
                                        <form action="/create" method="post">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select name="is_publish" required class="form-select form-control" id="">
                                ...
                                @foreach ($categori as $key => $item)
                                    <tr>
                                        ...
                                        <td>
                                                                ...
                                                                <div class="mb-3">
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <select name="is_publish" class="form-select form-control" id="">
                                                                            ...
                                                                            {{-- <option value="1"{{$item['is_publish']=='1'?'selected':''}}>Not Publish</option> --}}
                                                                            {{-- <option value="0">Not Publish</option> --}}
                                                                        </select>
                                                                    </div>
                                                                </div>
                                            ...
                                            <a href="/delete/{{ $item->id }}" onclick="return confirm('yakin?')" class="btn btn-danger">Delete</a>
                                        </td>
                                    </tr>
                                @endforeach
                                {{-- <div class=" my-5">
